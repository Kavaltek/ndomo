...
import appointment from './../../util/servicos.json'
import { 
  HiChevronLeft,
  HiChevronRight,
  HiOutlineNewspaper,
...
function Servico() {
  ...
  async function loadPostFreed(){
    await setAppointments(appointment.servicos)
  }
  ...
  return <main className='d-flex dashbord h-100 w-100'>
    ...
    <Container className='p-4'>
      ...
      <Card.Body className='d-flex justify-content-between'>
              <div>
                <div><h6><b>Lista de Serviços</b></h6></div>
              </div>
           ...
           <div className='h-tablet'>
            <table className="table" striped bordered hover>
              ...
              <tbody>
              {
                  appointments?.map(servicos => (
                    <tr>
                    <td className='ps-4'>{servicos.numero}</td>
                    <td>{servicos.servico}</td>
                    <td>{servicos.compartimento}</td>
                    <td>
