...
import appointment from './../../util/tipologia.json'
import { 
  HiChevronLeft,
  HiChevronRight,
  HiOutlineNewspaper,
...
function Tipologia() {
  ...
  async function loadPostFreed(){
    await setAppointments(appointment.tipologia)
  }
  ...
  return <main className='d-flex dashbord h-100 w-100'>
    ...
    <Container className='p-4'>
      ...
      <Card.Body className='d-flex justify-content-between'>
              <div>
                <div><h6><b>Lista de Tipologia</b></h6></div>
              </div>
           ...
           <div className='h-tablet'>
            <table className="table" striped bordered hover>
              ...
              <tbody>
              {
                  appointments?.map(tipologia => (
                    <tr>
                    <td className='ps-4'>{tipologia.numero}</td>
                    <td>{tipologia.predio}</td>
                    <td>{tipologia.totalAp}</td>
